...
|-----------|----------|------------|
| [`petstore-ts/`](./petstore-ts) | TypeScript | `cd petstore-ts && npm i && npx tsx main.mts` |
| [`petstore-go/`](./petstore-go) | Go | `cd petstore-go && go run .` |
| [`petstore-rust/`](./petstore-rust) | Rust | `cd petstore-rust && cargo run` |
