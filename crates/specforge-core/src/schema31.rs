...
pub struct Schema31 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "$dynamicRef")]
    pub dynamic_ref: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "$dynamicAnchor")]
...
pub fn is_nullable(schema: &Schema31) -> bool { type_list(schema).iter().any(|t| t == "null") }
impl Schema31 {
    pub fn from_json(value: &serde_json::Value) -> Result<Self, serde_json::Error> { serde_json::from_value(value.clone()) }
}
